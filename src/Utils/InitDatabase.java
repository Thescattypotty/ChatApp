...
abstract class InitDatabase {
    ...
    protected final String createTableUser = "CREATE TABLE USER(ID_user INT PRIMARY KEY , username VARCHAR(40) NOT NULL, password varchar(100) NOT NULL, UNIQUE(username) ); INSERT INTO USER(ID_user, username , password) VALUES(0,'yahya','yahyabgbg');";
